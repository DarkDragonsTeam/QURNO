    ...
    $(document).ready(function () {
      ...
      (a = 0),
        (window.onscroll = function () {
          ...
          350 < e && a <= e
            ? ((a = e), $(".header-nav").addClass("header-nav-unpinned"))
            : ((a = e), $(".header-nav").removeClass("header-nav-unpinned"));
        }),
        $('[data-toggle="search"]').on("click", function () {
          $(".search-block").addClass("is-visible"),
            setTimeout(function () {
              var e = $('[aria-label="search-query"]').val();
              $('[aria-label="search-query"]').focus().val("").val(e);
            }, 250);
        }),
